  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        ...
        success:
          "bg-green-500 text-white shadow hover:bg-green-500/90 dark:bg-green-900 dark:hover:bg-green-900/90",
        warning:
          "bg-yellow-500 text-white shadow hover:bg-yellow-500/90 dark:bg-yellow-900 dark:hover:bg-yellow-900/90",
        info:
          "bg-blue-500 text-white shadow hover:bg-blue-500/90 dark:bg-blue-900 dark:hover:bg-blue-900/90",
      },
      size: {
